...
const code = "masuk_sekolah"; //ganti code
const yen = 2; //hadiah yen
const exp = 2; //hadiah exp
module.exports = {
  config: {
    name: "redeem",
    version: "1.0",
...
if (event.senderID == 100088085177610) { //ganti dengan id mu
   if (hadi == "notif") { return api.sendMessage(`♡ 𝗥𝗲𝗱𝗲𝗲𝗺\n\n𝖢𝗈𝖽𝖾: ${code}\n𝖶𝖺𝗄𝗍𝗎: ${waktu}\n𝖡𝗎𝗋𝗎𝖺𝗇 𝗌𝖾𝖻𝖾𝗅𝗎𝗆 𝗄𝖾𝗁𝖺𝖻𝗂𝗌𝖺𝗇! 😎`, 6908687869245827); //ganti dengan id grup mu
}
}
...
return message.reply("𝖢𝗈𝖽𝖾 𝗋𝖾𝖽𝖾𝖾𝗆 𝗒𝖺𝗇𝗀 𝗍𝗎𝖺𝗇 𝗀𝗎𝗇𝖺𝗄𝖺𝗇 𝗍𝗂𝖽𝖺𝗄 𝖺𝖽𝖺!");
  ...
  if (waktu !== "15/07/2024") { //ganti tanggal sekarang
